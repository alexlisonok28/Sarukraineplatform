...
/** SAR Ukraine mark sized for the 56×56 header slot. */
const SarLogo = () => (
  <svg viewBox="0 0 160 160" width="56" height="56" role="img" aria-label="SAR Ukraine" className="block w-14 h-14">
  ...
  return (
    <header className="bg-white border-b border-gray-200 py-4 sticky top-0 z-[100]">
      <div className="max-w-[1400px] mx-auto px-6 flex justify-between items-center">
        <button type="button" aria-label="На головну" className="flex items-center gap-3 cursor-pointer bg-transparent border-none p-0" onClick={onHomeClick}><SarLogo /></button>
